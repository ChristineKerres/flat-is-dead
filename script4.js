...
function checkWidth() {
    console.log("resize")
    if (window.innerWidth < 600 && window.innerHeight < 800 && window.innerHeight > 300) {
        ...
        var element =  document.getElementById('newLink4');
        if (typeof(element) == 'undefined' || element == null)
        {
          // Exists.
            var newLink = document.createElement('a');
            var newText = document.createTextNode('To the next one.');
            ...
            newLink.href = '#';
            newLink.onclick=function(){window.open('index_05.html','window4','width=800,height=400')}
